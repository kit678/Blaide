    ...
    return (
        <div className={classNames(styles.root, className)}>
            ...
            <div className={styles.imageCloud}>
                ...
                <img src="/src/assets/logos/illinois-university.svg" alt="University of Illinois" />
                <img src="/src/assets/logos/illinois-university-2.svg" alt="University of Illinois" />
                <img src="/src/assets/logos/manipal.png" alt="Manipal University" />
                <img src="/src/assets/logos/morgan-stanley-new.svg" alt="Morgan Stanley" />
                <img src="/src/assets/logos/stevens-institute-of-technology.svg" alt="Stevens Institute of Technology" />
